...
/**
 * Created by ZHAO on 2017/9/06.
 */
@Table(name="wlw_runstatus_history")
@Entity
public class LiftRunHistory implements Serializable {
   ...
   // 轿厢报警按钮是否动作
    ...
    public LiftRunHistory(){

    }

    public LiftRunHistory(String deptId, String regcode, String isonline, String timestamps, String maincontactor,
