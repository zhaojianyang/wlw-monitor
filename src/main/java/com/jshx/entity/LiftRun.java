 ...
 */
@Table(name="wlw_runstatus")
@Entity
public class LiftRun implements Serializable {
   ...
   // 轿厢报警按钮是否动作
    ...
    public LiftRun(String deptId,String regcode, String isonline, String timestamps, String maincontactor,
